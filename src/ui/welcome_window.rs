    ...
    pub fn new(parent: &impl IsA<gtk4::Window>, is_first_run: bool) -> Self {
        ...
        if is_first_run {
            ...
            for item in [
                ...
                "Changed: the ≡ menu is grouped into seven labelled sections instead of ten unlabelled clusters, and Settings drops jargon like \"Debounce\" and a raw file path for plain language",
