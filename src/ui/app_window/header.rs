...
pub(super) struct Menus {
    ...
    pub(super) menu_what_things_do_item: Button,
    pub(super) menu_take_tour_item: Button,
...
pub(super) fn build_header() -> HeaderWidgets {
    ...
    let help_about_btn = super::make_submenu_button(
        ...
        &[
            ...
            menu_what_things_do_item.clone(),
            menu_take_tour_item.clone(),
