...
impl OutlinePanel {
    ...
    fn repopulate(&self, files: &[(PathBuf, String)]) {
        ...
        for (path, content) in files {
            ...
            let headings: Vec<(usize, usize, String)> = all_lines
                .iter()
                .enumerate()
                .filter_map(|(i, line)| {
                    if !line.starts_with('=') {
    ...
    pub fn select_for_line(&self, path: &PathBuf, line: u32) {
        ...
        match idx {
            Some(i) => {
                self.list_box
                    .select_row(self.list_box.row_at_index(i as i32).as_ref());
            }
            None => {
    ...
    vec![
        ...
        (
            ...
            vec![
                ...
                ("ύ", "upsilon + tonos"),
                ("ώ", "omega + tonos"),
                ("ΐ", "iota + dialytika + tonos"),
                ("ΰ", "upsilon + dialytika + tonos"),
                ("ἀ", "alpha + smooth"),
                ("ἁ", "alpha + rough"),
                ("ἂ", "alpha + smooth + grave"),
                ("ἃ", "alpha + rough + grave"),
                ("ἄ", "alpha + smooth + acute"),
                ("ἅ", "alpha + rough + acute"),
                ("ἆ", "alpha + smooth + circumflex"),
                ("ἇ", "alpha + rough + circumflex"),
                ("ἐ", "epsilon + smooth"),
                ("ἑ", "epsilon + rough"),
                ("ἒ", "epsilon + smooth + grave"),
                ("ἓ", "epsilon + rough + grave"),
                ("ἔ", "epsilon + smooth + acute"),
                ("ἕ", "epsilon + rough + acute"),
                ("ἠ", "eta + smooth"),
                ("ἡ", "eta + rough"),
                ("ἢ", "eta + smooth + grave"),
                ("ἣ", "eta + rough + grave"),
                ("ἤ", "eta + smooth + acute"),
                ("ἥ", "eta + rough + acute"),
                ("ἦ", "eta + smooth + circumflex"),
                ("ἧ", "eta + rough + circumflex"),
                ("ἰ", "iota + smooth"),
                ("ἱ", "iota + rough"),
                ("ἲ", "iota + smooth + grave"),
                ("ἳ", "iota + rough + grave"),
                ("ἴ", "iota + smooth + acute"),
                ("ἵ", "iota + rough + acute"),
                ("ἶ", "iota + smooth + circumflex"),
                ("ἷ", "iota + rough + circumflex"),
                ("ὀ", "omicron + smooth"),
                ("ὁ", "omicron + rough"),
                ("ὂ", "omicron + smooth + grave"),
                ("ὃ", "omicron + rough + grave"),
                ("ὄ", "omicron + smooth + acute"),
                ("ὅ", "omicron + rough + acute"),
                ("ὐ", "upsilon + smooth"),
                ("ὑ", "upsilon + rough"),
                ("ὒ", "upsilon + smooth + grave"),
                ("ὓ", "upsilon + rough + grave"),
                ("ὔ", "upsilon + smooth + acute"),
                ("ὕ", "upsilon + rough + acute"),
                ("ὖ", "upsilon + smooth + circumflex"),
                ("ὗ", "upsilon + rough + circumflex"),
                ("ὠ", "omega + smooth"),
                ("ὡ", "omega + rough"),
                ("ὢ", "omega + smooth + grave"),
                ("ὣ", "omega + rough + grave"),
                ("ὤ", "omega + smooth + acute"),
                ("ὥ", "omega + rough + acute"),
                ("ὦ", "omega + smooth + circumflex"),
                ("ὧ", "omega + rough + circumflex"),
